                                ...
                                <div class="cart_overview_modal_content">
                                    <ul>
                                        <li class="cart_items">
                                            <div class="image">
                                                <a href="#">
                                                    <img alt="product-image" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" srcset="/assets/image/IE-4000-4TC4G-E.avif"
                                                        src="/assets/image/IE-4000-4TC4G-E.avif" style="color: transparent;">
                                                </a>
                                            </div>
                                            <div class="title">
                                                <a href="#">
                                        ...
                                        <li class="cart_items">
                                            <div class="image">
                                                <a href="#">
                                                    <img alt="product-image" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" srcset="/assets/image/ISR4351-K9.avif"
                                                    src="/assets/image/ISR4351-K9.avif" style="color: transparent;">
                                                </a>
                                            </div>
                                            <div class="title">
                                                <a href="#">
