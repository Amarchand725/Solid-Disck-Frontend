<template>
    <div style="display: flex; flex-direction: column;">
        <h4 class="headlingTag">INFORMATION</h4>
        <router-link class="tags" title="Privacy Policy" to="/policies/privacy-policy">Privacy Policy</router-link>
        <router-link class="tags" title="Return Policy" to="/policies/return-policy">Return Policy</router-link>
        <router-link class="tags" title="Warranty Info" to="/policies/warranty">Warranty Info</router-link>
