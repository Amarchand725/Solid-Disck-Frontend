<template>
    ...
    <div class="TabProductCard_card_bottom__WLdA5">
        ...
        <button style="background-color: #f5ad1d !important;" @click="handleBuyItNow" :disabled="loadingBuyNow" class="TabProductCard_add_to_cart_btn___s_fG" title="Buy It Now">
