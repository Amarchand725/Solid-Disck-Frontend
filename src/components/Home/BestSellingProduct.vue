        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="payment_shipping_box">
                    ...
                    <img src="/assets/logos/payment-options.png" class="payment_shipping_img" alt="Secure Payment Methods Icon">
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div style="padding:34px !important;" class="payment_shipping_box">
                    ...
                    <img src="/assets/logos/fedex.png" class="payment_shipping_img" alt="Fedex Logo">
                </div>
            </div>
        </div>
    </div>
