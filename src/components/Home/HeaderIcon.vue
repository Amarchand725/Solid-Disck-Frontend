        ...
        <div class="d-inline-flex">
            <ul class="d-flex list-unstyled mb-0 align-items-center">
                    ...
                    <li class="col d-xl-none px-2 px-sm-3">
                        <a href="https://transvelo.github.io/electro-html/2.0/html/shop/my-account.html" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="My Account">
                    ...
                    <div id="basicDropdownHover" class="cart-dropdown dropdown-menu dropdown-unfold border-top border-top-primary mt-3 border-width-2 border-left-0 border-right-0 border-bottom-0 left-auto right-0" aria-labelledby="basicDropdownHoverInvoker">
                        ...
                        <div class="flex-center-between px-4 pt-2">
                                <router-link to="/cart" class="btn btn-soft-secondary mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5">
                                    View cart
                                </router-link>
                                <router-link to="/checkout" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5">
                                    Checkout
                                </router-link>
                        </div>
                    </div>
