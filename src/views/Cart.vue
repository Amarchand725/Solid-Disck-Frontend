                                        ...
                                        <div class="pt-md-3">
                                            <div class="d-block d-md-flex flex-center-between">
                                                ...
                                                <div class="d-md-flex">
                                                    ...
                                                    <router-link to="/checkout" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100 w-md-auto d-none d-md-inline-block">
                                                        Proceed to checkout
                                                    </router-link>
                                                </div>
                                            </div>
                ...
                <div class="mb-8 cart-total">
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 offset-lg-6 offset-xl-7 col-md-8 offset-md-4">
                            ...
                            <button type="button" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100 w-md-auto d-md-none">Proceed to checkout Tstedd</button>
                        </div>
                    </div>
                </div>
            </div>
